...
using System.Web;
using YogaEssentials1;
using YogaEssentials1.Models;
using System.Collections.Generic;
using System.Linq;

namespace YogaEssentials1.Logic
{
    ...
    public class NVPAPICaller
    {
        ...
        public string APIUsername = "sb-4ismh1345721_api1.business.example.com";
        private string APIPassword = "ZTZS9UADWFKNG7V2";
        private string APISignature = "AnzAfcRdB70-xjZFFOXaXK6UvAARA0gkxLTB3JMZ6Nv9nhEyFmhGQnhH";
        ...
        public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
        {
            ...
            string returnURL = "https://localhost:44307/Checkout/CheckoutReview.aspx";
            string cancelURL = "https://localhost:44307/Checkout/CheckoutCancel.aspx";

            NVPCodec encoder = new NVPCodec();
            encoder["METHOD"] = "SetExpressCheckout";
            encoder["RETURNURL"] = returnURL;
            encoder["CANCELURL"] = cancelURL;
            encoder["BRANDNAME"] = "YogaEssentials Website ";
            ...
            using (YogaEssentials1.Logic.ShoppingCartActions myCartOrders = new YogaEssentials1.Logic.ShoppingCartActions())
            {
